 ...
 */
    ...
    */
   define('CC_FB_SCRIPT_LAST_UPDATED', '08/31/2007');
    ...
    */   
   define('CC_FB_TO_EMAIL', 'info@admiraltravels.com');
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.admiraltravels.com/thankyou.html');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_DO_EMAIL && !(mail($mail_to,$subject,
            ...
            'Cc: ' . CC_FB_CC_EMAIL . CC_FB_SENDMAIL_EOL . 
            'Bcc: ' . CC_FB_BCC_EMAIL . CC_FB_SENDMAIL_EOL .
